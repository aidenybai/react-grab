...
const CheckIcon = (): ReactElement => (
  <svg width="14" height="14" viewBox="0 0 21 21" fill="none" className="shrink-0 text-black/85">
    <path
      d="M20.17 10.08C20.17 15.64 15.65 20.17 10.08 20.17C4.52 20.17 0 15.64 0 10.08C0 4.51 4.52 0 10.08 0C15.65 0 20.17 4.51 20.17 10.08ZM13 6.23L8.96 12.7L7.08 10.31C6.83 9.99 6.59 9.88 6.28 9.88C5.79 9.88 5.39 10.29 5.39 10.78C5.39 11.03 5.48 11.26 5.66 11.48L8.05 14.39C8.33 14.75 8.63 14.91 8.99 14.91C9.36 14.91 9.68 14.73 9.9 14.38L14.47 7.27C14.61 7.04 14.72 6.8 14.72 6.58C14.72 6.07 14.28 5.72 13.79 5.72C13.49 5.72 13.21 5.9 13 6.23Z"
      fill="currentColor"
    />
  </svg>
);
...
const DefaultCursor = (): ReactElement => (
  <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" transform="translate(10 7)">
      <path
        d="m6.14 18.47 1.86-1 1.61-.839-2.56-4.81h4.33l-11.37-11.4v16.01l3.31-3.22z"
        fill="#fff"
      />
      <path d="m6.43 17 1.76-.941-2.77-5.2h3.6l-8.02-8.04v11.18l2.53-2.44z" fill="#000" />
    </g>
  </svg>
);
  ...
  >
    <defs>
      ...
      <mask id="busye" fill="#fff">
        <path
          d="m1 23c0 4.97 4.03 9 9 9 4.97 0 9-4.02 9-9 0-4.97-4.03-9-9-9-4.97 0-9 4.02-9 9z"
          fill="#fff"
          fillRule="evenodd"
        />
      </mask>
    ...
    <g fill="none" fillRule="evenodd" transform="translate(7)">
      ...
      <g fillRule="nonzero">
        <path d="m0 16.42v-16.01l11.59 11.61h-7.04l-.151.12z" fill="#fff" />
        <path d="m1 2.81v11.18l2.96-2.86.16-.139h5.03z" fill="#000" />
      </g>
    </g>
  </svg>
);
