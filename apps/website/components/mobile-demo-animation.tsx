...
const CheckIcon = (): ReactElement => (
  <svg width="14" height="14" viewBox="0 0 21 21" fill="none" className="shrink-0 text-black/85">
    <path
      d="M20.18 10.09C20.18 15.65 15.66 20.175 10.09 20.175C4.53 20.175 0 15.65 0 10.09C0 4.52 4.53 0 10.09 0C15.66 0 20.18 4.52 20.18 10.09ZM13.01 6.24L8.97 12.7L7.08 10.31C6.83 9.99 6.6 9.89 6.29 9.89C5.79 9.89 5.4 10.29 5.4 10.79C5.4 11.04 5.49 11.26 5.66 11.49L8.06 14.4C8.33 14.75 8.63 14.91 9 14.91C9.36 14.91 9.68 14.73 9.91 14.39L14.47 7.27C14.61 7.05 14.73 6.81 14.73 6.58C14.73 6.07 14.281 5.73 13.79 5.73C13.49 5.73 13.217 5.91 13.01 6.24Z"
      fill="currentColor"
    />
  </svg>
);
