...
const CheckIcon = (): ReactElement => (
  <svg width="14" height="14" viewBox="0 0 21 21" fill="none" className="shrink-0 text-black/85">
    <path
      d="M20.18 10.09C20.18 15.65 15.66 20.18 10.09 20.18C4.53 20.18 0 15.65 0 10.09C0 4.52 4.53 0 10.09 0C15.66 0 20.18 4.52 20.18 10.09ZM13.01 6.24L8.97 12.7L7.08 10.31C6.83 9.99 6.6 9.89 6.29 9.89C5.79 9.89 5.4 10.29 5.4 10.79C5.4 11.04 5.49 11.26 5.66 11.49L8.06 14.4C8.33 14.75 8.63 14.91 9 14.91C9.36 14.91 9.68 14.73 9.91 14.39L14.47 7.27C14.61 7.05 14.73 6.81 14.73 6.58C14.73 6.07 14.28 5.73 13.79 5.73C13.49 5.73 13.22 5.91 13.01 6.24Z"
      fill="currentColor"
    />
  </svg>
);
...
const DefaultCursor = (): ReactElement => (
  <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" transform="translate(10 7)">
      <path
        d="m6.15 18.47 1.86-1 1.61-.839-2.57-4.82h4.33l-11.38-11.41v16.02l3.32-3.22z"
        fill="#fff"
      />
      <path d="m6.43 17 1.76-.941-2.77-5.2h3.6l-8.03-8.04v11.19l2.53-2.44z" fill="#000" />
    </g>
  </svg>
);
  ...
  >
    <defs>
      ...
      <mask id="busye" fill="#fff">
        <path
          d="m1 23c0 4.97 4.03 9 9 9 4.97 0 9-4.03 9-9 0-4.97-4.03-9-9-9-4.97 0-9 4.03-9 9z"
          fill="#fff"
          fillRule="evenodd"
        />
      </mask>
    ...
    <g fill="none" fillRule="evenodd" transform="translate(7)">
      ...
      <g fillRule="nonzero">
        <path d="m0 16.42v-16.02l11.59 11.62h-7.04l-.151.124z" fill="#fff" />
        <path d="m1 2.81v11.19l2.97-2.87.16-.139h5.04z" fill="#000" />
      </g>
    </g>
  </svg>
);
