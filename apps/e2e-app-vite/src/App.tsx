...
// Exercises the freeze dispatcher patching for hooks beyond useState:
// useReducer, useTransition, useSyncExternalStore, and context dependencies.
// Each value is bumped by a button whose handler does NOT go through useState,
// so a frozen page must hold the displayed value and replay the update on
// unfreeze. See freeze-updates.ts and freeze-hooks.spec.ts.
