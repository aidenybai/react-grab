...
export const PAGE_LOAD_POLL_INTERVAL_MS = 50;
export const PAGE_LOAD_MINIMUM_WAIT_MS = 100;
export const NON_CRITICAL_RESOURCE_TIMEOUT_MS = 3000;
export const LONG_RUNNING_REQUEST_TIMEOUT_MS = 10000;
export const MAX_URL_LENGTH_FOR_LOGGING = 500;
