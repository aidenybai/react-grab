...
const generalSettings: SettingField[] = [
  ...
  { key: "email", label: "Email Address", value: "admin@acme.dev", type: "email" },
  { key: "language", label: "Language", value: "en", type: "select", options: ["en", "es", "fr", "de", "ja"] },
  { key: "timezone", label: "Timezone", value: "America/New_York", type: "select", options: ["America/New_York", "America/Chicago", "America/Los_Angeles", "Europe/London", "Asia/Tokyo"] },
];
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 p-6">
      ...
      <div className="rounded-lg border bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-gray-500">Basic account information and preferences.</p>
