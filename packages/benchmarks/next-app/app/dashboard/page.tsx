...
const recentActivity = [
  ...
  { id: "2", user: "Bob Smith", action: "Updated billing settings", time: "15 minutes ago" },
  { id: "3", user: "Carol White", action: "Deployed to production", time: "1 hour ago" },
  { id: "4", user: "Dave Brown", action: "Added team member", time: "2 hours ago" },
  { id: "5", user: "Eve Davis", action: "Generated monthly report", time: "3 hours ago" },
];
