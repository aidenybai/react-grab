...
const intentColors: Record<ButtonIntent, { bg: string; color: string; hoverBg: string }> = {
...
const scaleSizes: Record<ButtonScale, { height: number; padding: string; fontSize: number }> = {
