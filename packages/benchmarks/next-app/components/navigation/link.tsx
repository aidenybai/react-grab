...
export function Link({ href, active = false, children, variant = "default", external = false, className }: NavLinkProps) {
  const variants = {
    default: active ? "text-gray-900 font-semibold" : "text-gray-500 hover:text-gray-900",
