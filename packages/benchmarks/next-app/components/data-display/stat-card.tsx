...
export function StatCard({ label, value, previousValue, icon, format, loading = false }: StatCardProps) {
    ...
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      ...
      {loading ? (
        ...
        <div className="mt-2">
          ...
          {change && (
            <span className={`ml-2 text-xs font-medium ${Number(change) >= 0 ? "text-green-600" : "text-red-600"}`}>
