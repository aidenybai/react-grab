...
export const ServerHero = () => {
  return (
    <section data-testid="server-hero" style={{ padding: 24, borderRadius: 12, border: "1px solid var(--border)" }}>
      <h2 style={{ fontSize: 20, fontWeight: 700, margin: 0 }}>Server Component Hero</h2>
