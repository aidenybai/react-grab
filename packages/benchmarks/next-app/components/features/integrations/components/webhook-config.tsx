...
export function WebhookConfig({
  ...
  secret = "",
  events = [],
  availableEvents = ["booking.created", "booking.cancelled", "booking.rescheduled", "payment.received"],
  onSave,
}: WebhookConfigProps) {
  ...
  return (
    <div className="webhook-config">
      ...
      <button className="btn btn-primary" onClick={() => onSave({ url, secret: webhookSecret, events: selectedEvents })}>
        Save Webhook
      </button>
    </div>
  );
