  ...
  return (
    <div className="org-domain-config">
      ...
      <div className="org-domain-config__add">
        ...
        <button className="btn btn-primary btn-sm" onClick={handleAdd}>Add Domain</button>
      </div>
      <div className="org-domain-config__list">
        {domains.map((d) => (
          <div key={d.domain} className="org-domain-config__item">
            ...
            <span className={`org-domain-config__status ${d.verified ? "org-domain-config__status--verified" : ""}`}>
              {d.verified ? "Verified" : "Pending"}
            </span>
            <div className="org-domain-config__actions">
              {!d.verified && <button className="btn btn-sm" onClick={() => onVerifyDomain(d.domain)}>Verify</button>}
              <button className="btn btn-sm btn-danger" onClick={() => onRemoveDomain(d.domain)}>Remove</button>
            </div>
          </div>
        ))}
      </div>
