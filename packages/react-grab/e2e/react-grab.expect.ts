...
for (const test of [
  ...
  "Activate and hover the Todo List. Hold ArrowDown to slide the highlight down the page and verify the box snaps onto whatever element it lands on when released. Press Tab to step out to the parent container, then Shift+Tab to step back into the child.",
