...
for (const test of [
  ...
  "Activate and hover the Todo List. Press ArrowDown twice to move the highlight to successive elements, then ArrowUp to go back. Press Shift+Tab to select the parent container, then Tab to go into a child.",
