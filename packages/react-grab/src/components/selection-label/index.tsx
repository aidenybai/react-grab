          ...
          <Show when={props.status === "copying"}>
            <div class="contain-layout shrink-0 flex flex-col justify-center items-start w-fit h-fit max-w-[280px]">
              <div class="contain-layout shrink-0 flex items-center gap-1 py-1.5 px-2 w-full h-fit">
                <IconLoader size={13} class="text-[#A7A7A7] shrink-0" />
              ...
              <BottomSection>
                <div class="shrink-0 flex justify-between items-end w-full min-h-4">
                  <textarea
                    ...
                    class="text-white text-[13px] leading-4 font-medium bg-transparent border-none outline-none resize-none flex-1 p-0 m-0 wrap-break-word overflow-y-auto"
                    style={{
                  ...
                  <Show when={props.onSubmit}>
                    <button
                      ...
                      class="contain-layout shrink-0 flex items-center justify-center size-4 rounded-full bg-white cursor-pointer ml-1 interactive-scale"
                      onClick={() => props.onSubmit?.()}
                    >
                      <IconSubmit size={10} class="text-[#161616]" />
                    </button>
                  </Show>
                </div>
              </BottomSection>
