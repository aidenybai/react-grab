...
// the P3 channels past SDR white so the highlight glows in the (headroom-
// constrained) extended range. It must NOT be set for plain-CSS consumers
// (e.g. box-shadow), which would gamut-clamp the out-of-range channels into a
// distorted hue.
