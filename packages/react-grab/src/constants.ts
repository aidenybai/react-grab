...
export const FREEFORM_STROKE_COLOR = `rgba(${GRAB_PURPLE_RGB}, 0.6)`;
export const FREEFORM_STROKE_MIN_WIDTH_PX = 2;
export const FREEFORM_STROKE_MAX_WIDTH_PX = 6;
export const FREEFORM_STROKE_DEFAULT_PRESSURE = 0.5;
export const FREEFORM_CIRCLE_MIN_ANGULAR_SWEEP_RAD = 4.0;
export const FREEFORM_MIN_POINTS_FOR_GESTURE = 5;
export const FREEFORM_IDLE_TIMEOUT_MS = 600;
export const FREEFORM_CLEANUP_GRACE_PERIOD_MS = 100;
