...
export const MODE: ColorMode = "dark" as ColorMode;

export const PANEL_STYLES =
  MODE === "dark" ? "bg-[rgba(30,30,30,0.95)]" : "bg-white";

export const TEXT_PRIMARY = MODE === "dark" ? "text-white" : "text-black";
export const TEXT_SECONDARY =
  MODE === "dark" ? "text-white/70" : "text-black/50";
export const TEXT_MUTED = MODE === "dark" ? "text-white/50" : "text-black/40";
export const BG_HOVER =
  MODE === "dark" ? "hover:bg-white/5" : "hover:bg-black/5";
export const BORDER_DIVIDER =
