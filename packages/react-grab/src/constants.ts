...
export const TOOLBAR_DRAG_PREVIEW_SHORT_PX = 28;
export const TOOLBAR_DRAG_PREVIEW_LONG_PX = 56;
export const TOOLBAR_DRAG_PREVIEW_ROTATION_DURATION_MS = 260;
export const TOOLBAR_DRAG_RELEASE_REVEAL_DURATION_MS = 180;
export const TOOLBAR_DRAG_RELEASE_ITEM_OFFSET_PX = 26;
export const TOOLBAR_DRAG_RELEASE_ICON_STAGGER_DELAY_MS = 50;
export const TOOLBAR_DRAG_RELEASE_ICON_STAGGER_COUNT = 3;
...
export const TOOLBAR_COMMENT_ICON_SIZE_PX = 15;
export const TOOLBAR_SIDE_DOCK_THRESHOLD_PX = 56;
export const TOOLBAR_DOCK_LAYOUT_ANIMATION_DURATION_MS = 220;
export const TOOLBAR_DOCK_PREVIEW_DISTANCE_PX = 220;
export const TOOLBAR_DOCK_PREVIEW_EDGE_SWITCH_HYSTERESIS_PX = 20;
