...
export const SCREENSHOT_LABEL_MIN_ELEMENT_WIDTH_PX = 80;
export const SCREENSHOT_LABEL_MIN_ELEMENT_HEIGHT_PX = 28;
export const SCREENSHOT_LABEL_COLLISION_PADDING_PX = 2;
