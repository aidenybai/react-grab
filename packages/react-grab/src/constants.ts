...
// Screenshot capture (getDisplayMedia → cropped canvas frame).
...
// Pencil glyph shared by the toolbar icon and the custom cursor.
export const DRAW_PENCIL_PATH_D =
  "M18.1213 2.70681C16.9498 1.53523 15.0503 1.53523 13.8787 2.7068L12.8879 3.69756L12.8786 3.7068L3.99997 12.5855L3.99238 12.5931L3.0572 13.5283L2.01006 20.8583C1.96555 21.1699 2.07034 21.4842 2.2929 21.7068C2.51547 21.9294 2.82984 22.0342 3.14143 21.9896L10.4714 20.9425L11.4142 19.9997L20.2929 11.121L21.2929 10.121C22.4645 8.94945 22.4645 7.04995 21.2929 5.87838L18.1213 2.70681ZM4.17852 19.8212L4.70712 16.121L7.87869 19.2926L4.17852 19.8212ZM16.7071 4.29265C16.3166 3.90212 15.6834 3.90212 15.2929 4.29265C14.9024 4.68317 14.9024 5.31634 15.2929 5.70686L18.2929 8.70686C18.6834 9.09739 19.3166 9.09739 19.7071 8.70686C20.0976 8.31634 20.0976 7.68317 19.7071 7.29265L16.7071 4.29265Z";
...
const DRAW_CURSOR_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" fill="#d239c0" stroke="#ffffff" stroke-width="1.1" stroke-linejoin="round" d="${DRAW_PENCIL_PATH_D}"/></svg>`;
