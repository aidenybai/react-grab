...
export const RENDER_SCAN_PRIMARY_COLOR = GRAB_PURPLE_RGB;
export const RENDER_SCAN_INTERPOLATION_SPEED = 0.1;
export const RENDER_SCAN_TOTAL_FRAMES = 45;
export const RENDER_SCAN_MAX_LABEL_LENGTH = 40;
...
export const MODE_SWITCH_HEIGHT_PX = 12;
export const MODE_SWITCH_KNOB_SIZE_PX = 8;
export const MODE_SWITCH_KNOB_OFFSET_PX = 2;
export const MODE_SWITCH_TWO_OPTION_WIDTH_PX = 20;
export const MODE_SWITCH_THREE_OPTION_WIDTH_PX = 29;
export const MODE_SWITCH_KNOB_POSITIONS_TWO = ["left-0.5", "left-2.5"];
export const MODE_SWITCH_KNOB_POSITIONS_THREE = [
  "left-0.5",
  "left-[10px]",
  "left-[19px]",
];
export const MODE_SWITCH_DOT_POSITIONS_TWO = ["left-1", "left-[12px]"];
export const MODE_SWITCH_DOT_POSITIONS_THREE = [
  "left-1",
  "left-[12px]",
  "left-[21px]",
];
export const MODE_SWITCH_TRACK_WIDTH_TWO = "w-5";
export const MODE_SWITCH_TRACK_WIDTH_THREE = "w-[29px]";
...
export const PERF_BUFFER_SIZE = 4096;
export const LOAF_THRESHOLD_MS = 50;
export const LOAF_MAX_ENTRIES = 100;

export const ACTIVITY_TYPE_EMPTY = 0;
export const ACTIVITY_TYPE_RENDER = 1;
export const ACTIVITY_TYPE_EFFECT = 2;

export const EFFECT_TYPE_PASSIVE = 0;
export const EFFECT_TYPE_LAYOUT = 1;
export const EFFECT_TYPE_INSERTION = 2;

export const EFFECT_PHASE_CREATE = 0;
export const EFFECT_PHASE_DESTROY = 1;

export const RENDER_PHASE_MOUNT = 0;
export const RENDER_PHASE_UPDATE = 1;

export const CAUSE_TYPE_INITIAL = 0;
export const CAUSE_TYPE_PROPS = 1;
