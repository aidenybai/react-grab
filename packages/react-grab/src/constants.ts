...
export const INSPECT_MAX_HOOKS = 8;
export const MAX_TIMELINE_COMMITS = 100;
export const RENDER_DURATION_NEGLIGIBLE_MS = 0.1;
export const RENDER_DURATION_FAST_MS = 2;
export const RENDER_DURATION_SLOW_MS = 16;
export const TIMELINE_HEIGHT_PX = 20;
export const TIMELINE_BAR_WIDTH_PX = 2;
export const TIMELINE_BAR_MIN_HEIGHT_PX = 2;
